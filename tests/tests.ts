...
(async () => {
    ...
    await tester.test(async () => {
        const [viewWallet, error] = WalletBackend.importViewWallet(
            ...
            'TRuybJFCU8BjP18bH3VZCNAu1fZ2r3d85SsU2w3VnJAHoRfnzLKgtTK2b58nfwDu59hKxwVuSMhTN31gmUW8nN9aoAN9N8Qyb',
        );
    ...
    await tester.test(async () => {
        const test1: boolean = prettyPrintAmount(12345607) === '123,456.07 TR';
        const test2: boolean = prettyPrintAmount(0) === '0.00 TR';
        const test3: boolean = prettyPrintAmount(-1234) === '-12.34 TR';
    ...
    await tester.test(async () => {
        ...
        const [seed2, err2] = wallet.getMnemonicSeedForAddress(
            'TRv1s9JQeHAJFoHvcqVBPyHYom2ynKeK6dpYptbp8gQNzdzE73ZD' +
            'kNmNurqfhhcMSUXpS1ZGEJKiKJUcPCyw7vYaCc354DCN1',
        );
    ...
    await tester.test(async () => {
        ...
        address = createIntegratedAddress(
            'TRv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW',
        ...
        const test1: boolean = address === 'TRuyzDT8wJ6bAmnmBLyRHmBNrRrafuR9G3bJTNzPiTAS4xKDQKHd9Aa2sF2q22DF9EXi5HNpZGcHGBwqgVAqc2AZxUBMMSegm8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyhJk2yR';

        let test2: boolean = false;

        try {
            createIntegratedAddress('TRv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW', '');
        } catch (err) {
            test2 = true;
        }
    ...
    await tester.test(async () => {
        const daemon2: IDaemon = new Daemon('127.0.0.1', 14486);
